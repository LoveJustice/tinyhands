...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.default_permissions_set'
    ...
    models = {
        u'accounts.account': {
            ...
            'default_permissions_set': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'accounts'", 'to': u"orm['accounts.DefaultPermissionsSet']"}),
