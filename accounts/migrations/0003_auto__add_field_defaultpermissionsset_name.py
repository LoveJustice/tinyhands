...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DefaultPermissionsSet.name'
        db.add_column(u'accounts_defaultpermissionsset', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Permission Set', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DefaultPermissionsSet.name'
        db.delete_column(u'accounts_defaultpermissionsset', 'name')
