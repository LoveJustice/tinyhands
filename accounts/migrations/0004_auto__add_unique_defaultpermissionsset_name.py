...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DefaultPermissionsSet', fields ['name']
        db.create_unique(u'accounts_defaultpermissionsset', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'DefaultPermissionsSet', fields ['name']
        db.delete_unique(u'accounts_defaultpermissionsset', ['name'])
