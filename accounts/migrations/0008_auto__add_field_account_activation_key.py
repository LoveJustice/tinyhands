...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.activation_key'
        db.add_column(u'accounts_account', 'activation_key',
                      self.gf('django.db.models.fields.CharField')(default='yvU8J9Pm1hAShPjTHFGHGTeNBI4ExoMC05QSlvWQ', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.activation_key'
        db.delete_column(u'accounts_account', 'activation_key')


    models = {
        u'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'activation_key': ('django.db.models.fields.CharField', [], {'default': "'J0w81QgEaCXKKh3BrGDw59iSswh3SpUVhgSrnJk1'", 'max_length': '40'}),
