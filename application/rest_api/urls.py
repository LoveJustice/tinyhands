...
urlpatterns = [
    # Data Entry App
       ...
       url(r'^user_permission/countries/current-user/$', UserLocationPermissionViewSet.as_view({'get':'user_countries_current_user'}), name='UserPermissionCountriesCurrent'),
        ...
        url(r'^gospel-verification/pvf-number/(?P<station_id>\d+)/(?P<form_number>[^/]+)/$', GospelVerificationViewSet.as_view({'get': 'retrieve_by_form_number'}), name='gospelVerificationFormNumber2'),
        ...
        url(r'^lf/$', LfFormViewSet.as_view(list), name='lf'),
        url(r'^lf/(?P<station_id>\d+)/(?P<pk>\d+)', LfFormViewSet.as_view({'get': 'my_retrieve', 'put': 'update', 'delete': 'destroy'}), name='lfDetail'),
        url(r'^lf/blank/(?P<station_id>\d+)', LfFormViewSet.as_view({'get': 'retrieve_blank_form'}), name='lfBlank'),
        url(r'^lf/associated/(?P<pk>\d+)', LfFormViewSet.as_view({'get': 'get_associated_incidents', 'put': 'set_associated_incidents'}), name='lfAssociated'),
        ...
        url(r'^legal-charge/$', LegalChargeFormViewSet.as_view(list), name='legalCharge'),
        url(r'^legal-charge/(?P<station_id>\d+)/(?P<pk>\d+)', LegalChargeFormViewSet.as_view({'get': 'my_retrieve', 'put': 'update', 'delete': 'destroy'}), name='legalChargeDetail'),
        url(r'^legal-charge/blank/(?P<station_id>\d+)', LegalChargeFormViewSet.as_view({'get': 'retrieve_blank_form'}), name='legalChargeBlank'),
        url(r'^legal-charge/incident/(?P<pk>\d+)', LegalChargeFormViewSet.as_view({'get': 'get_incident_detail'}), name='legalChargeIncident'),
        
        url(r'^legal-charge/country-specific/', LegalChargeCountrySpecificViewSet.as_view({'get': 'list'}), name='legalChargeCountrySpecific'),
        ...
        url(r'^incident/$', IncidentViewSet.as_view(list), name='Incident'),
        url(r'^incident/(?P<pk>\d+)/$', IncidentViewSet.as_view(detail), name='Incidentdetail'),
