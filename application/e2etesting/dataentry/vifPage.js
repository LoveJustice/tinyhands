...
var vifPage = function() {
    ...
    this.victim_address_address1 = element(by.id("id_victim_address_address1"));
    this.victim_address_address2 = element(by.id("id_victim_address_address2"));
    this.victim_guardian_address_address1 = element(by.id("id_victim_guardian_address_address1"));
    this.victim_guardian_address_address2 = element(by.id("id_victim_guardian_address_address2"));
    ...
    this.filloutVif = function(vifNumber) {
        ...
        this.victim_address_address1.sendKeys(c.vifAddressAddress1);
        this.victim_address_address2.sendKeys(c.vifAddressAddress2);
        this.victim_guardian_address_address1.sendKeys(c.vifVictimGuardianAddressAddress1);
        this.victim_guardian_address_address2.sendKeys(c.vifVictimGuardianAddressAddress2);
