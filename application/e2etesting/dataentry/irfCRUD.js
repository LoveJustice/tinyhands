...
var irfPage = function() {
    ...
    this.fillOutIRF = function(irfNumber, irfInterceptTime) {
        ...
        this.address1Select = element(by.id("id_interceptees-0-address1")).sendKeys(c.irfInterceptAddress1);
        this.address2Select = element(by.id("id_interceptees-0-address2")).sendKeys(c.irfInterceptAddress2);
