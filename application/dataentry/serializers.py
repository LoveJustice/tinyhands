...
class VictimInterviewPersonBoxSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            'victim_interview',
            'who_is_this_relationship_boss_of',
            'who_is_this_relationship_coworker_of',
            'who_is_this_relationship_own_relative_of',
            'who_is_this_role_broker',
            'who_is_this_role_companion',
            'who_is_this_role_india_trafficker',
            'who_is_this_role_contact_of_husband',
            'who_is_this_role_known_trafficker',
            'who_is_this_role_manpower',
            'who_is_this_role_passport',
            'who_is_this_role_sex_industry',
            'name',
            'gender',
            'address1',
            'address2',
            ...
            'height',
            'weight',
            'physical_description_kirat',
            'physical_description_sherpa',
            'physical_description_madeshi',
            'physical_description_pahadi',
            'physical_description_newari',
            'appearance_other',
            'occupation_none',
            'occupation_agent',
            'occupation_business_owner',
            'occupation_other',
            'occupation_wage_labor',
            'occupation_job_in_india',
            'occupation_job_in_gulf',
            'occupation_farmer',
            'occupation_teacher',
            'occupation_police',
            'occupation_army',
            ...
            'political_party_congress',
            'political_party_maoist',
            'political_party_uml',
            'political_party_forum',
            'political_party_tarai_madesh',
            'political_party_shadbawona',
            'political_party_rnt',
            'political_party_njf',
            'political_party_loktantrak',
            'political_party_dont_know',
            'political_party_other',
            'political_party_other_value',
            'where_spends_time',
            'interviewer_believes_definitely_trafficked',
            'interviewer_believes_have_trafficked',
            'interviewer_believes_suspects_trafficked',
            'interviewer_believes_not_trafficker',
            'victim_believes_definitely_trafficked',
            'victim_believes_have_trafficked',
            'victim_believes_suspects_trafficked',
            'victim_believes_not_trafficker',
            'associated_with_place',
            'associated_with_place_value'
        ]
...
class VictimInterviewLocationBoxSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            'victim_interview',
            'which_place_india_meetpoint',
            'which_place_manpower',
            'which_place_transit_hideout',
            'which_place_destination',
            'which_place_passport',
            'which_place_nepal_meet_point',
            'which_place_known_location',
            'which_place_sex_industry',
            'what_kind_place_persons_house',
            'what_kind_place_bus_station',
            'what_kind_place_train_station',
            'what_kind_place_shop',
            'what_kind_place_factory',
            'what_kind_place_brothel',
            'what_kind_place_hotel',
            'signboard',
            'location_in_town',
            'address1',
            'address2',
            ...
            'nearby_signboards',
            'other',
            'interviewer_believes_trafficked_many_girls',
            'interviewer_believes_trafficked_some_girls',
            'interviewer_believes_suspect_used_for_trafficking',
            'interviewer_believes_not_used_for_trafficking',
            'victim_believes_trafficked_many_girls',
            'victim_believes_trafficked_some_girls',
            'victim_believes_suspect_used_for_trafficking',
            'victim_believes_not_used_for_trafficking',
            'associated_with_person',
            'associated_with_person_value'
        ]
