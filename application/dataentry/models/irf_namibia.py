...
class IntercepteeNamibia(IntercepteeCore):
    interception_record = models.ForeignKey(IrfNamibia, related_name='interceptees', on_delete=models.CASCADE)
...
class IrfAttachmentNamibia(IrfAttachment):
    interception_record = models.ForeignKey(IrfNamibia)
