...
class IrfZimbabwe(IrfCore):
    # Group - Zimbabwe specific
    ...
    # Family - Zimbabwe specific
    
    # Signs - Zimbabwe specific
    ...
    # Final Procedures - Zimbabwe specific
    case_notes = models.TextField('Case Notes', blank=True)
    
class IntercepteeZimbabwe(IntercepteeCore):
    interception_record = models.ForeignKey(IrfZimbabwe, related_name='interceptees', on_delete=models.CASCADE)
...
class IrfAttachmentZimbabwe(IrfAttachment):
    interception_record = models.ForeignKey(IrfZimbabwe)
