...
class IrfIndiaNetwork(IrfCore):
    ...
    # Appearance
    noticed_foreign_looking = models.BooleanField('IndiaNetworkn looking', default=False)
...
class IntercepteeIndiaNetwork(IntercepteeCore):
    interception_record = models.ForeignKey(IrfIndiaNetwork, related_name='interceptees', on_delete=models.CASCADE)
...
class IrfAttachmentIndiaNetwork(IrfAttachment):
    interception_record = models.ForeignKey(IrfIndiaNetwork)
