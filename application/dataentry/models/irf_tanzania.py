...
class IrfTanzania(IrfCore):
    # Group - Tanzania specific
    ...
    # Final Procedures - Tanzania specific
    
class IntercepteeTanzania(IntercepteeCore):
    interception_record = models.ForeignKey(IrfTanzania, related_name='interceptees', on_delete=models.CASCADE)
...
class IrfAttachmentTanzania(IrfAttachment):
    interception_record = models.ForeignKey(IrfTanzania)
