# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2023-04-04 12:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dataentry', '0251_auto_20230315_1344'),
    ]
    ...
    operations = [
        ...
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set profile = replace(profile, 'Disabled Child', 'Disabled') "\
                            "where station_id in ("\
                                "select dbs.id "\
                                "from dataentry_borderstation dbs "\
                                    "inner join dataentry_country dc on dc.id = dbs.operating_country_id "\
        ...
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set industry = replace(industry, 'Diamond mine', 'Mine') "\
                            "where station_id in ("\
                                ...
                                "where dc.name in ('Sierra Leone'))"),
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set industry = replace(industry, 'Farm', 'Agriculture') "\
                            "where station_id in ("\
                                "select dbs.id "\
                                "from dataentry_borderstation dbs "\
                                    "inner join dataentry_country dc on dc.id = dbs.operating_country_id "\
