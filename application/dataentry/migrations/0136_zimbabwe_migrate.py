...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dataentry', '0135_auto_20200316_1728'),
    ]
    ...
    operations = [
        migrations.RunSQL("update dataentry_irfcommon set noticed_young_looking=true "\
                          ...
                          "station_id in (select s.id from dataentry_borderstation s, dataentry_country c where s.operating_country_id = c.id and c.name in ('Zimbabwe','Uganda','Malawi'))"),
        ...
        migrations.RunSQL("update dataentry_irfcommon set vulnerability_family_unwilling=under_18_family_unwilling "\
                          "where station_id in (select s.id from dataentry_borderstation s, dataentry_country c where s.operating_country_id = c.id and c.name in ('Zimbabwe','Uganda','Malawi'))"),
        ...
        migrations.RunSQL("update dataentry_irfcommon set industry=("\
                          ...
                          "station_id in (select s.id from dataentry_borderstation s, dataentry_country c where s.operating_country_id = c.id and c.name in ('Zimbabwe', 'Malawi'))"),
        migrations.RunSQL("update dataentry_irfcommon set industry=("\
        ...
        migrations.RunSQL("update dataentry_irfcommon set industry=("\
                          ...
                          "station_id in (select s.id from dataentry_borderstation s, dataentry_country c where s.operating_country_id = c.id and c.name in ('Zimbabwe'))"),
        migrations.RunSQL("update dataentry_irfcommon set industry=("\
                          ...
                          "station_id in (select s.id from dataentry_borderstation s, dataentry_country c where s.operating_country_id = c.id and c.name in ('Uganda'))"),
    ]
