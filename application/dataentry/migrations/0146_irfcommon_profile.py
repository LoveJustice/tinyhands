# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2020-06-03 12:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dataentry', '0145_populate_master_person'),
    ]

    operations = [
        migrations.RunSQL("drop view if exists irfcombined"),
        migrations.AddField(
        ...
        migrations.AlterField(
            model_name='irfcommon',
            name='industry',
            field=models.CharField(blank=True, max_length=1024, verbose_name='Industry'),
        ),
        migrations.AlterField(
            model_name='irfcommon',
            name='where_going_destination',
        ...
        migrations.RunSQL("update dataentry_irfcommon set profile = (case when profile='' then 'Young looking woman' else profile || ';Young looking woman' end) "\
                          ...
                          "c.name in ('Zimbabwe','Uganda','Sierra Leone','Malawi','Kenya','India Network'))"),
