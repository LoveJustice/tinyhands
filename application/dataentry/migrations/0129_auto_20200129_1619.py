# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2020-01-29 16:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('dataentry', '0128_monthlyreportattachment'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_entered_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cifindianetwork_entered_by', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_entered_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cifrwanda_entered_by', to=settings.AUTH_USER_MODEL)),
                ('main_pv', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dataentry.Person')),
                ('station', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dataentry.BorderStation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cif', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dataentry.CifIndiaNetwork')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flag_count', models.PositiveIntegerField(blank=True, null=True)),
                ('address2', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dataentry.Address2')),
                ('cif', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dataentry.CifRwanda')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='cif',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dataentry.CifRwanda'),
        ),
        migrations.AddField(
            model_name='cifattachmentindianetwork',
            name='cif',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dataentry.CifIndiaNetwork'),
        ),
    ]
