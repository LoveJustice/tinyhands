# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2023-02-14 13:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dataentry', '0245_auto_20230130_1903'),
    ]
    ...
    operations = [
        ...
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set profile = replace(profile, 'Escaping an exploitative situation', 'Recently enslaved') "\
                            "where station_id in ("\
                                ...
                                "where dc.name in ('Burundi','Indonesia','Lesotho','Mozambique'))"),
        ...
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set industry = replace(industry, 'Rural work', 'Agriculture') "\
                            "where station_id in ("\
                                ...
                                "where dc.name in ('Burundi'))"),
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set industry = replace(industry, 'Agricultural work', 'Agriculture') "\
                            "where station_id in ("\
                                "select dbs.id "\
                                "from dataentry_borderstation dbs "\
                                    "inner join dataentry_country dc on dc.id = dbs.operating_country_id "\
                                "where dc.name in ('Burundi'))"),
         migrations.RunSQL("update dataentry_irfcommon "\
                          "set industry = replace(industry, 'Gold mining', 'Mine') "\
                            "where station_id in ("\
                                "select dbs.id "\
                                "from dataentry_borderstation dbs "\
                                    "inner join dataentry_country dc on dc.id = dbs.operating_country_id "\
        ...
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set profile = replace(profile, 'Revealing clothing', 'Wearing revealing clothing') "\
                            "where station_id in ("\
                                "select dbs.id "\
                                "from dataentry_borderstation dbs "\
                                    "inner join dataentry_country dc on dc.id = dbs.operating_country_id "\
                                "where dc.name in ('Indonesia'))"),
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set where_going_destination = replace(where_going_destination, 'don\'\'t know', 'PV doesn\'\'t know') "\
                            "where station_id in ("\
                                "select dbs.id "\
                                "from dataentry_borderstation dbs "\
                                    "inner join dataentry_country dc on dc.id = dbs.operating_country_id "\
                                "where dc.name in ('Indonesia'))"),
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set industry = replace(industry, 'Mining', 'Mine') "\
                            "where station_id in ("\
                                "select dbs.id "\
                                "from dataentry_borderstation dbs "\
                                    "inner join dataentry_country dc on dc.id = dbs.operating_country_id "\
                                "where dc.name in ('Indonesia'))"),
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set industry = replace(industry, 'Plantation', 'Agriculture') "\
                            "where station_id in ("\
                                "select dbs.id "\
                                "from dataentry_borderstation dbs "\
                                    "inner join dataentry_country dc on dc.id = dbs.operating_country_id "\
        ...
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set profile = replace(profile, 'Impoverished', 'Extremely poor') "\
                            "where station_id in ("\
                                ...
                                "from dataentry_borderstation dbs "\
                                    "inner join dataentry_country dc on dc.id = dbs.operating_country_id "\
                                "where dc.name in ('Lesotho'))"),
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set industry = replace(industry, 'Farm work', 'Agriculture') "\
                            "where station_id in ("\
                                "select dbs.id "\
                                "from dataentry_borderstation dbs "\
                                    "inner join dataentry_country dc on dc.id = dbs.operating_country_id "\
