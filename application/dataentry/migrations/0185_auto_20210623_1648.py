# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2021-06-23 16:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dataentry', '0184_auto_20210611_1243'),
    ]

    operations = [
        migrations.RunSQL("drop view if exists vdfcombined"),
        migrations.AlterField(
            model_name='vdfcommon',
            name='why_sent_home_with_with_alarms',
            field=models.TextField(max_length=126, null=True, verbose_name='If the potential victim has 10 or more total Home Situation Alarms and you recommend sending the potential victim home to stay with guardians, why?'),
        ),
        ...
        migrations.RunSQL("update dataentry_vdfcommon "\
                          ...
                          "c.name in ('South Africa', 'Sierra Leone', 'Zimbabwe'))"),
        migrations.RunSQL("update dataentry_vdfcommon "\
