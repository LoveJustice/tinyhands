# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2023-01-19 14:27
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dataentry', '0240_auto_20230118_1403'),
    ]
    ...
    operations = [
        ...
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set profile = replace(profile, 'From a rural area', 'From rural area') "\
                            "where station_id in ("\
                                "select dbs.id "\
                                "from dataentry_borderstation dbs "\
                                    "inner join dataentry_country dc on dc.id = dbs.operating_country_id "\
                                "where dc.name in ('Liberia'))"),
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set industry = replace(industry, 'Diamond mine', 'Mine') "\
                            ...
                            "and station_id in ("\
                                ...
                                "where dc.name in ('Liberia'))"),
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set industry = replace(industry, 'Rubber plantation', 'Agriculture') "\
                            "where industry like '%Salon%' "\
                            "and station_id in ("\
                                "select dbs.id "\
                                "from dataentry_borderstation dbs "\
