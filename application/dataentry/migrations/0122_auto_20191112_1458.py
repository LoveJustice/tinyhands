# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2019-11-12 14:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('dataentry', '0121_country_options'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_entered_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vdfkenya_entered_by', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logbook_notes', models.TextField(blank=True, verbose_name='Logbook Notes')),
                ('logbook_submitted', models.DateField(null=True)),
                ('form_entered_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vdfmalawi_entered_by', to=settings.AUTH_USER_MODEL)),
                ('station', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dataentry.BorderStation')),
                ('victim', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dataentry.Person')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logbook_notes', models.TextField(blank=True, verbose_name='Logbook Notes')),
                ('logbook_submitted', models.DateField(null=True)),
                ('form_entered_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vdfsouthafrica_entered_by', to=settings.AUTH_USER_MODEL)),
                ('station', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dataentry.BorderStation')),
                ('victim', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dataentry.Person')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logbook_notes', models.TextField(blank=True, verbose_name='Logbook Notes')),
                ('logbook_submitted', models.DateField(null=True)),
                ('form_entered_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vdftanzania_entered_by', to=settings.AUTH_USER_MODEL)),
                ('station', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dataentry.BorderStation')),
                ('victim', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dataentry.Person')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logbook_notes', models.TextField(blank=True, verbose_name='Logbook Notes')),
                ('logbook_submitted', models.DateField(null=True)),
                ('form_entered_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vdfzimbabwe_entered_by', to=settings.AUTH_USER_MODEL)),
                ('station', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dataentry.BorderStation')),
                ('victim', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dataentry.Person')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='vdf',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dataentry.VdfZimbabwe'),
        ),
        migrations.AddField(
            model_name='vdfattachmenttanzania',
            name='vdf',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dataentry.VdfTanzania'),
        ),
        migrations.AddField(
            model_name='vdfattachmentsouthafrica',
            name='vdf',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dataentry.VdfSouthAfrica'),
        ),
        migrations.AddField(
            model_name='vdfattachmentmalawi',
            name='vdf',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dataentry.VdfMalawi'),
        ),
        migrations.AddField(
            model_name='vdfattachmentkenya',
            name='vdf',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dataentry.VdfKenya'),
        ),
    ]
