# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2021-01-19 17:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dataentry', '0170_legalcasetimeline'),
    ]
    ...
    operations = [
        ...
        migrations.RunSQL("update dataentry_irfcommon set profile = (case when profile='' then 'Migrant' else profile || ';Migrant' end) "\
                          ...
                          "station_id in (select s.id from dataentry_borderstation s, dataentry_country c where s.operating_country_id = c.id and "\
                          "c.name in ('Nepal'))"),
        migrations.RunSQL("update dataentry_irfcommon set profile = (case when profile='' then 'Carrying a baby' else profile || ';Carrying a baby' end) "\
                          "where noticed_carrying_a_baby = true and "\
                          "profile not like '%Carrying a baby%' and "\
                          "station_id in (select s.id from dataentry_borderstation s, dataentry_country c where s.operating_country_id = c.id and "\
                          "c.name in ('Nepal'))"),
        ...
        migrations.RunSQL("update dataentry_irfcommon set control_no_address_phone = true where no_address_at_destination=true or no_company_phone=true"),
    ]
