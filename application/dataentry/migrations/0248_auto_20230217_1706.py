# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2023-02-17 17:06
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dataentry', '0247_auto_20230215_1515'),
    ]
    ...
    operations = [
        ...
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set profile = replace(profile, 'Escaping an exploitative situation', 'Recently enslaved') "\
                            "where station_id in ("\
                                ...
                                "where dc.name in ('Uganda','Zambia'))"),
        ...
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set industry = replace(industry, 'Massage Parlor', 'Spa/massage') "\
                            "where station_id in ("\
                                "select dbs.id "\
                                "from dataentry_borderstation dbs "\
                                    "inner join dataentry_country dc on dc.id = dbs.operating_country_id "\
                                "where dc.name in ('Uganda'))"),
        ...
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set profile = replace(profile, 'Impoverished', 'Extremely poor') "\
                            "where station_id in ("\
                                ...
                                "from dataentry_borderstation dbs "\
                                    "inner join dataentry_country dc on dc.id = dbs.operating_country_id "\
                                "where dc.name in ('Zambia'))"),
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set profile = replace(profile, 'From a rural area', 'Frpm rural area') "\
                            "where station_id in ("\
                                "select dbs.id "\
                                "from dataentry_borderstation dbs "\
                                    "inner join dataentry_country dc on dc.id = dbs.operating_country_id "\
        ...
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set industry = replace(industry, 'Mining', 'Mine') "\
                            "where station_id in ("\
                                ...
                                "where dc.name in ('Zambia'))"),
        migrations.RunSQL("update dataentry_irfcommon "\
                          "set evade_signs_forged_false_documentation = true "\
                            "where evade_signs_fake_documentation = true and station_id in ("\
                                "select dbs.id "\
                                "from dataentry_borderstation dbs "\
                                    "inner join dataentry_country dc on dc.id = dbs.operating_country_id "\
                                "where dc.name in ('Zambia'))"),
