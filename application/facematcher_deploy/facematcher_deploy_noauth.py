...
def display_selected_and_closest_match_images(given_encoding, selected_person, selected_person_image):
...
def main():
    ...
    selected_countries, selected_roles, selected_genders = handle_sidebar()
    ...
    if given_encoding is not None and given_encoding.size > 0 and selected_person_image:
        display_selected_and_closest_match_images(given_encoding, selected_person, selected_person_image)
