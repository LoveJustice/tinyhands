...
class MatchingData(models.Model):
    analyzedPerson = models.OneToOneField(AnalyzedPerson, on_delete=models.DO_NOTHING)
    matchingPersons = models.ForeignKey(MatchingPerson, on_delete=models.DO_NOTHING)
