        ...
        if value is not None:
            for field in instance._meta.fields:
                if field.name.startswith(self.data_name) and (
                        isinstance(field, models.BooleanField) or isinstance(field, models.BooleanField)):
    ...
    def exportField(self, instance):
        for field in instance._meta.fields:
            if field.name.startswith(self.data_name):
                ...
                if value:
                    if isinstance(field, models.BooleanField) or isinstance(field, models.BooleanField):
