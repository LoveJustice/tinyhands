...
(function() {
  var $cur_input, list_of_names, list_of_pics, search, setupInputHandlers;
  ...
  search = function(input, $ui) {
    var $button, $li, $span, $ul, f, item, result, results, _i, _len, _ref, _results;
    $button = $cur_input.parent().parent().find(".photo-upload-button");
