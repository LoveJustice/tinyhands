...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VictimInterview.statement_read_before_beginning'
        db.add_column(u'dataentry_victiminterview', 'statement_read_before_beginning',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'VictimInterview.permission_to_use_photograph'
        db.add_column(u'dataentry_victiminterview', 'permission_to_use_photograph',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VictimInterview.statement_read_before_beginning'
        db.delete_column(u'dataentry_victiminterview', 'statement_read_before_beginning')

        # Deleting field 'VictimInterview.permission_to_use_photograph'
        db.delete_column(u'dataentry_victiminterview', 'permission_to_use_photograph')
