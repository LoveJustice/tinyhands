...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VictimInterviewLocationBox.victim_interview'
        db.add_column(u'dataentry_victiminterviewlocationbox', 'victim_interview',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='location_boxes', to=orm['dataentry.VictimInterview']),
                      keep_default=False)

        # Adding field 'VictimInterviewPersonBox.victim_interview'
        db.add_column(u'dataentry_victiminterviewpersonbox', 'victim_interview',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='person_boxes', to=orm['dataentry.VictimInterview']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VictimInterviewLocationBox.victim_interview'
        db.delete_column(u'dataentry_victiminterviewlocationbox', 'victim_interview_id')

        # Deleting field 'VictimInterviewPersonBox.victim_interview'
        db.delete_column(u'dataentry_victiminterviewpersonbox', 'victim_interview_id')
