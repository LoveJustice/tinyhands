...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VictimInterview.victim_where_going_gulf'
        db.add_column(u'dataentry_victiminterview', 'victim_where_going_gulf',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VictimInterview.victim_where_going_gulf'
        db.delete_column(u'dataentry_victiminterview', 'victim_where_going_gulf')


    models = {
        u'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'activation_key': ('django.db.models.fields.CharField', [], {'default': "'69m7dcZ006NdQ4sCX7M2iYASqRIupdzTKeJ4grj6'", 'max_length': '40'}),
