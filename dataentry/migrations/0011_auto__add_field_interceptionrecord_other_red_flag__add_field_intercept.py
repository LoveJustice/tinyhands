...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InterceptionRecord.other_red_flag'
        db.add_column(u'dataentry_interceptionrecord', 'other_red_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'InterceptionRecord.other_red_flag_value'
        db.add_column(u'dataentry_interceptionrecord', 'other_red_flag_value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InterceptionRecord.other_red_flag'
        db.delete_column(u'dataentry_interceptionrecord', 'other_red_flag')

        # Deleting field 'InterceptionRecord.other_red_flag_value'
        db.delete_column(u'dataentry_interceptionrecord', 'other_red_flag_value')
