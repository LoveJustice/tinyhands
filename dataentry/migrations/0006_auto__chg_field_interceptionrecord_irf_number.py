...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dataentry_interceptionrecord', 'irf_number', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'InterceptionRecord.irf_number'
        db.alter_column(u'dataentry_interceptionrecord', 'irf_number', self.gf('django.db.models.fields.IntegerField')())
