...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interceptee.photo'
        db.add_column(u'dataentry_interceptee', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Interceptee.photo'
        db.delete_column(u'dataentry_interceptee', 'photo')
