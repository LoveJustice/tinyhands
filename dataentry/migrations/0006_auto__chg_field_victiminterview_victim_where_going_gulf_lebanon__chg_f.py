...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VictimInterview.victim_where_going_gulf_lebanon'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_lebanon', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_gulf_didnt_know'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_didnt_know', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_gulf_malaysia'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_malaysia', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_gulf_saudi_arabia'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_saudi_arabia', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_gulf_qatar'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_qatar', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_gulf_other'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_other', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_gulf_kuwait'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_kuwait', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_gulf_dubai'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_dubai', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_gulf_oman'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_oman', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'VictimInterview.victim_where_going_gulf_lebanon'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_lebanon', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_gulf_didnt_know'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_didnt_know', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_gulf_malaysia'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_malaysia', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_gulf_saudi_arabia'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_saudi_arabia', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_gulf_qatar'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_qatar', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_gulf_other'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_other', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_gulf_kuwait'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_kuwait', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_gulf_dubai'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_dubai', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_gulf_oman'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_gulf_oman', self.gf('django.db.models.fields.BooleanField')())

    models = {
        u'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'activation_key': ('django.db.models.fields.CharField', [], {'default': "'cv4lLu012QcTdcB6v0cAnIUYWtyfobPDOHh2RoXq'", 'max_length': '40'}),
        ...
        u'dataentry.interceptionrecord': {
            'Meta': {'ordering': "['-date_time_last_updated']", 'object_name': 'InterceptionRecord'},
            ...
            'trafficker_taken_into_custody': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        u'dataentry.victiminterview': {
            'Meta': {'ordering': "['-date_time_last_updated']", 'object_name': 'VictimInterview'},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interviewer': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            ...
            'victim_where_going_gulf_didnt_know': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'victim_where_going_gulf_dubai': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'victim_where_going_gulf_kuwait': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'victim_where_going_gulf_lebanon': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'victim_where_going_gulf_malaysia': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'victim_where_going_gulf_oman': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'victim_where_going_gulf_other': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'victim_where_going_gulf_other_value': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'victim_where_going_gulf_qatar': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'victim_where_going_gulf_saudi_arabia': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'victim_where_going_india_bihar': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'victim_where_going_india_delhi': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'victim_where_going_india_didnt_know': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'victim_where_going_india_jaipur': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'victim_where_going_india_kolkata': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'victim_where_going_india_mumbai': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'victim_where_going_india_other': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'victim_where_going_india_other_value': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'victim_where_going_india_pune': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'victim_where_going_india_rajastan': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'victim_where_going_india_surat': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'victim_where_going_region_gulf': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'victim_where_going_region_india': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
