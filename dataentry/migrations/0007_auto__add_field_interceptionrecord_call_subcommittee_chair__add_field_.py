...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InterceptionRecord.call_subcommittee_chair'
        db.add_column(u'dataentry_interceptionrecord', 'call_subcommittee_chair',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'InterceptionRecord.call_thn_to_cross_check'
        db.add_column(u'dataentry_interceptionrecord', 'call_thn_to_cross_check',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'InterceptionRecord.name_come_up_before_yes'
        db.add_column(u'dataentry_interceptionrecord', 'name_come_up_before_yes',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'InterceptionRecord.name_come_up_before_no'
        db.add_column(u'dataentry_interceptionrecord', 'name_come_up_before_no',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        ...
        # Adding field 'InterceptionRecord.scan_and_submit_same_day'
        db.add_column(u'dataentry_interceptionrecord', 'scan_and_submit_same_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        ...
        # Adding field 'InterceptionRecord.type_indian_circus'
        db.add_column(u'dataentry_interceptionrecord', 'type_indian_circus',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        ...
        # Adding field 'InterceptionRecord.trafficker_taken_into_custody'
        db.add_column(u'dataentry_interceptionrecord', 'trafficker_taken_into_custody',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'InterceptionRecord.how_sure_was_trafficking'
        db.add_column(u'dataentry_interceptionrecord', 'how_sure_was_trafficking',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5),
                      keep_default=False)

        # Adding field 'InterceptionRecord.has_signature'
        db.add_column(u'dataentry_interceptionrecord', 'has_signature',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'InterceptionRecord.scanned_form'
        db.add_column(u'dataentry_interceptionrecord', 'scanned_form',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InterceptionRecord.call_subcommittee_chair'
        db.delete_column(u'dataentry_interceptionrecord', 'call_subcommittee_chair')

        # Deleting field 'InterceptionRecord.call_thn_to_cross_check'
        db.delete_column(u'dataentry_interceptionrecord', 'call_thn_to_cross_check')

        # Deleting field 'InterceptionRecord.name_come_up_before_yes'
        db.delete_column(u'dataentry_interceptionrecord', 'name_come_up_before_yes')

        # Deleting field 'InterceptionRecord.name_come_up_before_no'
        db.delete_column(u'dataentry_interceptionrecord', 'name_come_up_before_no')
        ...
        # Deleting field 'InterceptionRecord.scan_and_submit_same_day'
        db.delete_column(u'dataentry_interceptionrecord', 'scan_and_submit_same_day')
        ...
        # Deleting field 'InterceptionRecord.type_indian_circus'
        db.delete_column(u'dataentry_interceptionrecord', 'type_indian_circus')

        # Deleting field 'InterceptionRecord.type_runaway'
        db.delete_column(u'dataentry_interceptionrecord', 'type_runaway')

        # Deleting field 'InterceptionRecord.trafficker_taken_into_custody'
        db.delete_column(u'dataentry_interceptionrecord', 'trafficker_taken_into_custody')

        # Deleting field 'InterceptionRecord.how_sure_was_trafficking'
        db.delete_column(u'dataentry_interceptionrecord', 'how_sure_was_trafficking')

        # Deleting field 'InterceptionRecord.has_signature'
        db.delete_column(u'dataentry_interceptionrecord', 'has_signature')

        # Deleting field 'InterceptionRecord.scanned_form'
        db.delete_column(u'dataentry_interceptionrecord', 'scanned_form')
    ...
    models = {
        ...
        u'dataentry.interceptionrecord': {
            ...
            'trafficker_taken_into_custody': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
