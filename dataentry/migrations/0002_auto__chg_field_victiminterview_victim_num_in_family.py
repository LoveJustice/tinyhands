...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VictimInterview.victim_num_in_family'
        db.alter_column(u'dataentry_victiminterview', 'victim_num_in_family', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'VictimInterview.victim_num_in_family'
        db.alter_column(u'dataentry_victiminterview', 'victim_num_in_family', self.gf('django.db.models.fields.IntegerField')())

    models = {
        u'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'activation_key': ('django.db.models.fields.CharField', [], {'default': "'jfqTbu8DG02cYXZDdPWHRyvnkVqWn6zLdSdrsngL'", 'max_length': '40'}),
