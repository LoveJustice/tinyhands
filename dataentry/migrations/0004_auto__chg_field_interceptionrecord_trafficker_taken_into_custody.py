...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dataentry_interceptionrecord', 'trafficker_taken_into_custody', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    models = {
        u'accounts.account': {
            ...
            'activation_key': ('django.db.models.fields.CharField', [], {'default': "'7ox2it4itlFaIiZFxkWtEn4GLbDH4Pb95jR84LyV'", 'max_length': '40'}),
