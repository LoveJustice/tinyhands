...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VictimInterview.victim_is_literate'
        db.alter_column(u'dataentry_victiminterview', 'victim_is_literate', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'VictimInterview.victim_is_literate'
        db.alter_column(u'dataentry_victiminterview', 'victim_is_literate', self.gf('django.db.models.fields.BooleanField')())
