...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InterceptionRecord.noticed_other_sign'
        db.add_column(u'dataentry_interceptionrecord', 'noticed_other_sign',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'InterceptionRecord.noticed_other_sign_value'
        db.add_column(u'dataentry_interceptionrecord', 'noticed_other_sign_value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InterceptionRecord.noticed_other_sign'
        db.delete_column(u'dataentry_interceptionrecord', 'noticed_other_sign')

        # Deleting field 'InterceptionRecord.noticed_other_sign_value'
        db.delete_column(u'dataentry_interceptionrecord', 'noticed_other_sign_value')
