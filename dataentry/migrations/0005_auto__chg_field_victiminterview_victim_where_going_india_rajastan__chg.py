...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VictimInterview.victim_where_going_india_rajastan'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_rajastan', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_india_surat'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_surat', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_india_kolkata'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_kolkata', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_india_bihar'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_bihar', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_india_delhi'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_delhi', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_india_mumbai'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_mumbai', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_india_other'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_other', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_india_didnt_know'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_didnt_know', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_india_jaipur'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_jaipur', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_india_pune'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_pune', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_region_india'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_region_india', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'VictimInterview.victim_where_going_region_gulf'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_region_gulf', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'VictimInterview.victim_where_going_india_rajastan'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_rajastan', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_india_surat'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_surat', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_india_kolkata'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_kolkata', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_india_bihar'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_bihar', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_india_delhi'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_delhi', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_india_mumbai'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_mumbai', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_india_other'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_other', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_india_didnt_know'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_didnt_know', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_india_jaipur'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_jaipur', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_india_pune'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_india_pune', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_region_india'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_region_india', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VictimInterview.victim_where_going_region_gulf'
        db.alter_column(u'dataentry_victiminterview', 'victim_where_going_region_gulf', self.gf('django.db.models.fields.BooleanField')())

    models = {
        u'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'activation_key': ('django.db.models.fields.CharField', [], {'default': "'Xbkuk2YGWmiTxgToKutgi9wdEchKoTBvqjzaIsvX'", 'max_length': '40'}),
