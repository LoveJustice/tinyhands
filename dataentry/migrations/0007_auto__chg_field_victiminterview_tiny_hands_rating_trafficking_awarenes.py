...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VictimInterview.tiny_hands_rating_trafficking_awareness'
        db.alter_column(u'dataentry_victiminterview', 'tiny_hands_rating_trafficking_awareness', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'VictimInterview.tiny_hands_rating_shelter_accommodations'
        db.alter_column(u'dataentry_victiminterview', 'tiny_hands_rating_shelter_accommodations', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'VictimInterview.tiny_hands_rating_border_staff'
        db.alter_column(u'dataentry_victiminterview', 'tiny_hands_rating_border_staff', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'VictimInterview.tiny_hands_rating_shelter_staff'
        db.alter_column(u'dataentry_victiminterview', 'tiny_hands_rating_shelter_staff', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'VictimInterview.tiny_hands_rating_trafficking_awareness'
        raise RuntimeError("Cannot reverse this migration. 'VictimInterview.tiny_hands_rating_trafficking_awareness' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'VictimInterview.tiny_hands_rating_trafficking_awareness'
        db.alter_column(u'dataentry_victiminterview', 'tiny_hands_rating_trafficking_awareness', self.gf('django.db.models.fields.PositiveIntegerField')())

        # User chose to not deal with backwards NULL issues for 'VictimInterview.tiny_hands_rating_shelter_accommodations'
        raise RuntimeError("Cannot reverse this migration. 'VictimInterview.tiny_hands_rating_shelter_accommodations' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'VictimInterview.tiny_hands_rating_shelter_accommodations'
        db.alter_column(u'dataentry_victiminterview', 'tiny_hands_rating_shelter_accommodations', self.gf('django.db.models.fields.PositiveIntegerField')())

        # User chose to not deal with backwards NULL issues for 'VictimInterview.tiny_hands_rating_border_staff'
        raise RuntimeError("Cannot reverse this migration. 'VictimInterview.tiny_hands_rating_border_staff' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'VictimInterview.tiny_hands_rating_border_staff'
        db.alter_column(u'dataentry_victiminterview', 'tiny_hands_rating_border_staff', self.gf('django.db.models.fields.PositiveIntegerField')())

        # User chose to not deal with backwards NULL issues for 'VictimInterview.tiny_hands_rating_shelter_staff'
        raise RuntimeError("Cannot reverse this migration. 'VictimInterview.tiny_hands_rating_shelter_staff' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'VictimInterview.tiny_hands_rating_shelter_staff'
        db.alter_column(u'dataentry_victiminterview', 'tiny_hands_rating_shelter_staff', self.gf('django.db.models.fields.PositiveIntegerField')())

    models = {
        u'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'activation_key': ('django.db.models.fields.CharField', [], {'default': "'E0hJdU4N84uaNSOI7rxMz1yjGxlb2ZZPnMwXa1tr'", 'max_length': '40'}),
