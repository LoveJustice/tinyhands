...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dataentry_interceptionrecord', 'how_sure_was_trafficking', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'InterceptionRecord.contact_paid'
        db.alter_column(u'dataentry_interceptionrecord', 'contact_paid', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'InterceptionRecord.contact_paid'
        raise RuntimeError("Cannot reverse this migration. 'InterceptionRecord.contact_paid' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'InterceptionRecord.contact_paid'
        db.alter_column(u'dataentry_interceptionrecord', 'contact_paid', self.gf('django.db.models.fields.BooleanField')())
