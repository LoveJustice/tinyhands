...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VictimInterview.staff_name'
        db.delete_column(u'dataentry_victiminterview', 'staff_name')

        # Adding field 'VictimInterview.interviewer'
        db.add_column(u'dataentry_victiminterview', 'interviewer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'VictimInterview.staff_name'
        db.add_column(u'dataentry_victiminterview', 'staff_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'VictimInterview.interviewer'
        db.delete_column(u'dataentry_victiminterview', 'interviewer')
