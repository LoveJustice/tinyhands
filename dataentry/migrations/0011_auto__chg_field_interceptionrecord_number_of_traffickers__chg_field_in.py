...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'InterceptionRecord.number_of_traffickers'
        raise RuntimeError("Cannot reverse this migration. 'InterceptionRecord.number_of_traffickers' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'InterceptionRecord.number_of_traffickers'
        db.alter_column(u'dataentry_interceptionrecord', 'number_of_traffickers', self.gf('django.db.models.fields.IntegerField')())

        # User chose to not deal with backwards NULL issues for 'InterceptionRecord.number_of_victims'
        raise RuntimeError("Cannot reverse this migration. 'InterceptionRecord.number_of_victims' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'InterceptionRecord.number_of_victims'
        db.alter_column(u'dataentry_interceptionrecord', 'number_of_victims', self.gf('django.db.models.fields.IntegerField')())
