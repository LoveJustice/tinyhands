...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interceptee.gender'
        db.add_column(u'dataentry_interceptee', 'gender',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Interceptee.gender'
        db.delete_column(u'dataentry_interceptee', 'gender')
