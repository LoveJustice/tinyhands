...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VictimInterview.vif_number'
        db.alter_column(u'dataentry_victiminterview', 'vif_number', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'VictimInterview.vif_number'
        db.alter_column(u'dataentry_victiminterview', 'vif_number', self.gf('django.db.models.fields.IntegerField')())
