...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InterceptionRecord.interception_type'
        db.alter_column(u'dataentry_interceptionrecord', 'interception_type', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'Interceptee.kind'
        db.alter_column(u'dataentry_interceptee', 'kind', self.gf('django.db.models.fields.CharField')(default='', max_length=4))

        # Changing field 'Interceptee.gender'
        db.alter_column(u'dataentry_interceptee', 'gender', self.gf('django.db.models.fields.CharField')(default='', max_length=4))

    def backwards(self, orm):

        # Changing field 'InterceptionRecord.interception_type'
        db.alter_column(u'dataentry_interceptionrecord', 'interception_type', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Interceptee.kind'
        db.alter_column(u'dataentry_interceptee', 'kind', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Interceptee.gender'
        db.alter_column(u'dataentry_interceptee', 'gender', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        u'dataentry.interceptee': {
            ...
            'kind': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'}),
