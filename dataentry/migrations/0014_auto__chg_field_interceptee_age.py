...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Interceptee.age'
        raise RuntimeError("Cannot reverse this migration. 'Interceptee.age' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Interceptee.age'
        db.alter_column(u'dataentry_interceptee', 'age', self.gf('django.db.models.fields.PositiveIntegerField')())
