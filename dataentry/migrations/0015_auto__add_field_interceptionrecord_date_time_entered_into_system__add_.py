...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InterceptionRecord.date_time_entered_into_system'
        db.add_column(u'dataentry_interceptionrecord', 'date_time_entered_into_system',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 5, 27, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'InterceptionRecord.date_time_last_updated'
        db.add_column(u'dataentry_interceptionrecord', 'date_time_last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 5, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InterceptionRecord.date_time_entered_into_system'
        db.delete_column(u'dataentry_interceptionrecord', 'date_time_entered_into_system')

        # Deleting field 'InterceptionRecord.date_time_last_updated'
        db.delete_column(u'dataentry_interceptionrecord', 'date_time_last_updated')


    models = {
        u'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'activation_key': ('django.db.models.fields.CharField', [], {'default': "'MukQ1xBSFyvs18kLy2XZEEPIIfc40lKhDFsfbFos'", 'max_length': '40'}),
        ...
        u'dataentry.victiminterview': {
            ...
            'victim_where_going_region': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
