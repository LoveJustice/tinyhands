...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Interceptee.kind'
        raise RuntimeError("Cannot reverse this migration. 'Interceptee.kind' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Interceptee.kind'
        db.alter_column(u'dataentry_interceptee', 'kind', self.gf('django.db.models.fields.IntegerField')())
